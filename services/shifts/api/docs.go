...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_httpapi.createBulkBookingRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "internal_httpapi.createBulkBookingItem": {
            "type": "object",
            "properties": {
                "date": {
                    "type": "string"
        ...
        "internal_httpapi.createBulkBookingRequest": {
            "type": "object",
            "properties": {
                "bookings": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_httpapi.createBulkBookingItem"
                    }
                }
            }
        },
