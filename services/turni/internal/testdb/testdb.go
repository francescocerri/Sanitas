...
// which differs between internal/turno and internal/httpapi even though
// both call this same helper.
...
// real schema already applied (the same migrations/0001_init.sql used by
// deploy/docker-compose.yml), and returns a ready-to-use pool plus a cleanup
// function. Meant to be called once from a package's TestMain.
