...
7. [ ] **API: prenotazioni multiple atomiche (volontario)**: endpoint bulk che accetta più slot in un'unica richiesta e li crea tutti o nessuno (transazione), per prenotarsi su più giorni in un colpo solo.
