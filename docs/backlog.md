...
6. [ ] **API: prenotazione diretta per un volontario (gestore turni)**: il gestore crea una prenotazione già confermata per un volontario scelto da lui — nessuna approvazione necessaria.
