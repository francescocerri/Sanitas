...
2. [ ] **API: gestione turni-template (gestore turni)**: endpoint CRUD sui turni-template ricorrenti, dietro il nuovo permesso `shifts:configure` (voce 1) — non `shifts:write`. Seed iniziale per Pavullo: giovedì sera 20:00–08:00, sabato 08:00–14:00/14:00–20:00/20:00–08:00, domenica 08:00–14:00/14:00–20:00.
