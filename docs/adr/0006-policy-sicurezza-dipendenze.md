...
- **Toolchain allineata a versioni mantenute**: Node aggiornato a 24 LTS (da 20.11, troppo vecchio per Vite 8) invece di restare su una major di Vite più vecchia solo per compatibilità — coerente con "dipendenze mantenute" applicato anche al runtime, non solo alle librerie.
