...
`registry` deve gestire login, sessioni e permessi per gli altri servizi. Nessuna auto-registrazione: gli account li crea un amministratore, il nuovo utente li attiva tramite un token di invito impostando la propria password.
