# 0001. Nome del progetto: Sanitas
...
- Nessun riferimento a "croce rossa/CRI" nel nome del prodotto, del repository (`francescocerri/sanitas`) o nei moduli Go (`github.com/francescocerri/sanitas/...`).
- Il Comitato di Pavullo resta il primo deployment/cliente di riferimento, ma va sempre trattato come *un* fork, non come l'identità del prodotto — coerente con il [contratto di forkabilità](../../CLAUDE.md#contratto-di-forkabilità-regola-non-negoziabile) in `CLAUDE.md`.
